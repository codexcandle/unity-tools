...
class ScriptUsageTimeline:MonoBehaviour
{
    ...
    void Start()
    {
        ...
        musicInstance = FMODUnity.RuntimeManager.CreateInstance("event:/2D_events/MusicEvent");
    ...
    void OnGUI()
    {
// Debug.Log(" - timelineInfo.currentMusicBar: " + timelineInfo.currentMusicBar);
    ...
    {
                      Debug.Log("-on  BeatEventCallback!");
